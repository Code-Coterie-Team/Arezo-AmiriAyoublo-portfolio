    ...
    return(
        <div id="mywork" className="grid grid-cols-1 gap-10 pt-10 ">
            ...
            <div className="grid grid-cols-1 gap-8 pt-20">
                <Samplework project={'Kanban '} image={'/kanban.jpg'} link={'/apps/kanban'} projectlink="" gitlink={'https://github.com/Code-Coterie-Team/github-user-search'}/>
                <Samplework project={'real-state'} image={'/real-estate.png'} link={'/apps/real-state'} projectlink="" gitlink={'https://github.com/Code-Coterie-Team/home-landing-page'}/>
