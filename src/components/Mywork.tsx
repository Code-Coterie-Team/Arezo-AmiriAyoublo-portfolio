    ...
    return(
        <div id="mywork" className="grid grid-cols-1 gap-10 pt-10 ">
            ...
            <div className="grid grid-cols-1 gap-8 pt-20">
                <Samplework project={'CryptoDashboard'} image={'/cryptodashboard.png'} link={'/cryptoDashboard'} projectlink={"https://cryptodashboardarezoo.netlify.app/"} gitlink={'https://github.com/arezooamiri/cryptodashboard'}/>
