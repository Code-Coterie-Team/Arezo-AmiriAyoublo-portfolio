...
const Calculator=()=>{
    return(
        <div  className="grid grid-cols-1 gap-4 h-full">
            <AboutKanban  project={'Calculator'} description={"This project is a  calculator application built using React and Tailwind CSS, designed to perform basic arithmetic operations with an intuitive and user-friendly interface."}  imageproject={"/calculator.png"}/>
           <Challenge/>
            <Soultion/>
